...
// #define DEFAULT_IF	"macsec0"
#define DEFAULT_IF	"eth0"
//
// #define MY_DEST_MAC0	0xa4
// #define MY_DEST_MAC1	0x4c
// #define MY_DEST_MAC2	0xc8
// #define MY_DEST_MAC3	0x57
// #define MY_DEST_MAC4	0xcf
// #define MY_DEST_MAC5	0x8f
// #define DEFAULT_IF	"macsec0"
																														...
																														eh->ether_dhost[3] = MY_DEST_MAC3;
																															eh->ether_dhost[4] = MY_DEST_MAC4;
																																eh->ether_dhost[5] = MY_DEST_MAC5;
																																	...
																																	eh->ether_type = htons(0x7744);
																																		tx_len += sizeof(struct ether_header);

																																			/* Packet data */
																																		        int pkt_i;
																																			for (pkt_i=1; pkt_i<=82; ++pkt_i) {
																																				sendbuf[tx_len++] = 0xff;
																																			}
